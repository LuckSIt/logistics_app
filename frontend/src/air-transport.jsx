...
function AirTransportPage({ token, user }) {
  ...
  const downloadKP = async () => {
    ...
    try {
      ...
      a.href = url
      a.download = `air_offer_${offerId}.pdf`
      a.click()
            ...
            {rows ? (
              <>
                ...
                <div className="notes-section">
                  <div className="note">
                    <strong>💰 Стоимость включает:</strong> Авиатариф + СВХ (если выбрано) + автовывоз (если выбрано)
                  </div>
                  <div className="note">
                    <strong>⏱️ Сроки:</strong> Express: 1-3 дня, Standard: 3-7 дней, Economy: 7-14 дней
                  </div>
                  <div className="note">
                    <strong>📋 Документы:</strong> Авианакладная, документы на груз, сертификаты, инвойс
                  </div>
                  <div className="note">
                    <strong>✈️ Особенности:</strong> Учитываются аэропортовые сборы, топливные надбавки, срочность
                  </div>
                </div>
              </>
            ) : (
              <div style={{ textAlign: 'center', padding: '20px', color: '#666' }}>
                {isLoading ? (
                  '✈️ Рассчитываем стоимость авиадоставки...'
                ) : (
...
export default AirTransportPage
