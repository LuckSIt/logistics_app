...
function SeaTransportPage({ token, user }) {
  ...
  const downloadKP = async () => {
    ...
    try {
      ...
      a.href = url
      a.download = `sea_offer_${offerId}.pdf`
      a.click()
            ...
            {rows ? (
              <>
                ...
                <div className="notes-section">
                  <div className="note">
                    <strong>💰 Стоимость включает:</strong> Тарификатор моря + СВХ (если выбрано) + автовывоз (если выбрано)
                  </div>
                  <div className="note">
                    <strong>⏱️ Сроки:</strong> Обычно 7-45 дней в зависимости от маршрута и типа судна
                  </div>
                  <div className="note">
                    <strong>📋 Документы:</strong> Коносамент, документы на груз, сертификаты, инвойс
                  </div>
                  <div className="note">
                    <strong>🌊 Особенности:</strong> Учитываются портовые сборы, фрахт, демередж
                  </div>
                </div>
              </>
            ) : (
              <div style={{ textAlign: 'center', padding: '20px', color: '#666' }}>
                {isLoading ? (
                  '🚢 Рассчитываем стоимость морской доставки...'
                ) : (
...
export default SeaTransportPage
